...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = woxcarsFirebaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  String _currentPageName = 'VideoPlayer';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Visibility(
        ...
        child: FloatingNavbar(
          ...
          selectedItemColor: Color(0xFF0067FF),
                ...
                children: [
                  Icon(
                    currentIndex == 0
                        ? Icons.home_rounded
                        : Icons.home_outlined,
                    color: currentIndex == 0 ? Color(0xFF0067FF) : Colors.black,
                    size: 26.0,
                  ),
                ],
              ),
              ...
              customWidget: Column(
                ...
                children: [
                  Icon(
                    ...
                    color: currentIndex == 1 ? Color(0xFF0067FF) : Colors.black,
                    size: 25.0,
                  ),
                ],
              ),
